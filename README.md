...
- **Auto-Save Directory**: Optionally set a local directory to automatically archive all generated and processed images (PNG or WebP) without relying on manual downloads.
